...
@Component({
  selector: 'app-boardmaharashtra',
  templateUrl: './boardmaharashtra.component.html',
  styleUrls: ['./boardmaharashtra.component.scss']
})
export class BoardmaharashtraComponent {
